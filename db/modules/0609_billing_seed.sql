...
('il-01', 'inv-01', 'ps-01', 'Consultation', NULL, 200000, 1, 0, 0, 0, 200000, '2026-08-25 02:50:00'),
('il-02', 'inv-01', 'ps-02', 'Tooth extraction — tooth 46', '46', 1200000, 1, 0, 0, 0, 1200000, '2026-08-28 08:00:00');

UPDATE invoice SET status='Issued', invoice_serial='1C26TAA', invoice_number='0000001', issued_at='2026-08-28 08:00:00' WHERE id='inv-01';

INSERT INTO payment (id, invoice_id, direction, amount, method, paid_at, received_by, reference_number, notes) VALUES
('pay-01', 'inv-01', 'In', 200000, 'Cash', '2026-08-25 02:55:00', 'u-rec01', NULL, 'Consultation settled on the day.'),
('pay-02', 'inv-01', 'In', 1200000, 'BankTransfer', '2026-08-28 08:30:00', 'u-rec01', 'VCB-20260828-0417', 'Extraction settled.');
...
('il-03', 'inv-02', 'pr-05', 'Consultation and orthodontic records', 200000, 1, 0, 0, 0, 200000, '2026-08-25 03:10:00');

UPDATE invoice SET status='Issued', invoice_serial='1C26TAA', invoice_number='0000002', issued_at='2026-08-25 03:10:00' WHERE id='inv-02';

INSERT INTO payment (id, invoice_id, direction, amount, method, paid_at, received_by, reference_number, notes) VALUES
('pay-03', 'inv-02', 'In', 200000, 'Card', '2026-08-25 03:15:00', 'u-rec01', 'POS-771204', 'Paid before records were taken.');
...
('il-04', 'inv-03', 'ps-06', 'Scale and polish — full mouth', 500000, 1, 0, 0, 0, 500000, '2026-09-02 07:35:00');

UPDATE invoice SET status='Issued', invoice_serial='1C26TAA', invoice_number='0000003', issued_at='2026-09-02 07:35:00' WHERE id='inv-03';

INSERT INTO payment (id, invoice_id, direction, amount, method, paid_at, received_by, notes) VALUES
('pay-04', 'inv-03', 'In', 500000, 'Cash', '2026-09-02 07:40:00', 'u-rec01', NULL);
...
INSERT INTO invoice_line (id, invoice_id, session_id, description, unit_price, quantity, discount_amount, vat_rate, vat_amount, line_total, issued_at) VALUES
('il-05', 'inv-04', 'ps-07', 'In-clinic teeth whitening', 3000000, 1, 300000, 10, 270000, 3000000, '2026-09-01 09:40:00'),
('il-06', 'inv-04', 'ps-08', 'Scale and polish', 500000, 1, 50000, 0, 0, 500000, '2026-09-01 09:40:00');

UPDATE invoice SET status='Issued', invoice_serial='1C26TAA', invoice_number='0000004', issued_at='2026-09-01 09:40:00' WHERE id='inv-04';

INSERT INTO payment (id, invoice_id, direction, amount, method, paid_at, received_by, reference_number, notes) VALUES
('pay-05', 'inv-04', 'In', 3420000, 'BankTransfer', '2026-09-01 09:45:00', 'u-rec01', 'TCB-20260901-0088', 'Staff rate, XASH voucher applied.');
...
('il-08', 'inv-05', 'ps-09', 'Composite filling — tooth 37, three surfaces', '37', 'MOD', 800000, 3, 240000, 0, 0, 2400000, '2026-09-03 03:35:00');

UPDATE invoice SET status='Issued', invoice_serial='1C26TAA', invoice_number='0000005', issued_at='2026-09-03 03:35:00' WHERE id='inv-05';

INSERT INTO payment (id, invoice_id, direction, amount, method, paid_at, received_by, notes) VALUES
('pay-07', 'inv-05', 'In', 1000000, 'Cash', '2026-09-03 03:40:00', 'u-rec01', 'Part payment; balance agreed for the next visit.');
...
('tf-01', 'pr-02', '46', '2026-09-01 02:00:00', 'Ongoing pain and swelling at the extraction site four days after the tooth was removed.', 'Periapical shows a retained mesial root fragment approximately 4mm. Socket inflamed.', 'u-doc04', 'Resolved', 'ClinicTechnique', 'Both', 'u-mgr01', '2026-09-01 04:30:00', 'Fragment left at the original extraction. Clinic technique. Refund the extraction fee and remove the fragment at no charge. Charge the loss back to the operating dentist.');
...
('il-07', 'inv-01', 'pr-02', 'CREDIT — extraction refunded, retained root fragment (tf-01)', '46', 1200000, 1, 0, 0, 0, -1200000, 'il-02', '2026-09-01 04:45:00');

INSERT INTO payment (id, invoice_id, direction, amount, method, paid_at, received_by, reference_number, notes) VALUES
('pay-06', 'inv-01', 'Out', 1200000, 'BankTransfer', '2026-09-01 05:00:00', 'u-rec01', 'VCB-20260901-0902', 'Refund of extraction fee, tf-01.');
...
('d-45', 'pr-13', NULL, 'Proposed', 'u-doc04', '2026-09-01 04:40:00', 'Remedy for tf-01, at no charge.'),
('d-46', 'pr-13', 'Proposed', 'Accepted', 'u-rec01', '2026-09-01 04:45:00', 'Patient accepted the free rework.');
